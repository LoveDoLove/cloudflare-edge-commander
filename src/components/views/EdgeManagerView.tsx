...
import { Globe, ChevronRight, Loader2, Edit3, Trash2, Check, X, Award, Shield, CloudCog } from 'lucide-react';
                 ...
                 {state.loadStates.dns ? (
                   ...
                   <table className="table table-xs w-full min-w-150 border-collapse text-left">
                      ...
                      <tbody>
                        ...
                        {state.dnsRecords.length === 0 && !state.loadStates.dns && (<tr><td colSpan={5} className="py-12 text-center text-[10px] font-black text-slate-400 uppercase tracking-widest">{t.registry_empty}</td></tr>)}
                      </tbody>
                   </table>
                 )}
              </div>
